    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h2 fw-bold text-dark mb-2">Create New Designation</h1>
                    <p class="text-muted mb-0">Add a new designation to a department</p>
                </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('department.store-designation') }}" method="POST">
                        @csrf
                        <div class="row g-4">
                            <div class="col-md-6">
