    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h2 fw-bold text-dark mb-2">Designation Management</h1>
                ...
                <div class="btn-group" role="group">
                    ...
                    <a href="{{ route('department.create-designation') }}" class="btn btn-primary d-flex align-items-center">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <ul class="nav nav-tabs" id="departmentTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="designations-tab" data-bs-toggle="tab" data-bs-target="#designations" type="button" role="tab" aria-controls="designations" aria-selected="true">
                        <i class="bi bi-briefcase me-2"></i>
                        Designations
                        <span class="badge bg-primary ms-2">{{ $designations->count() }}</span>
                    </button>
                </li>
            </ul>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-3">
                    <form method="GET" action="{{ route('department.designations') }}" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('department.designations') }}" class="btn btn-outline-secondary w-100">
                ...
                <div class="card-body p-0">
                                    ...
                                    @foreach($designations as $designation)
                                        <tr class="align-middle">
                                            ...
                                            <td class="py-3 text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('department.show-designation', $designation) }}" 
                                                       class="btn btn-sm btn-outline-info" 
                                                       title="View Details">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="{{ route('department.edit-designation', $designation) }}" 
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('department.create-designation') }}" class="btn btn-primary">
                                <i class="bi bi-plus me-2"></i>
                                Add New Designation
                            </a>
                        </div>
